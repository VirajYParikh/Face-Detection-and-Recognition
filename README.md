...
### Step 4: Facial Landmarks:
There are various other features and applications that Open CV and other image processing packages have to offer which can be useful in a variety of ways. Another one of the is identifying the facial landmarks. 
